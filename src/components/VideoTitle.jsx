  ...
  return (
    <div className='w-screen aspect-video pt-[25%] px-16 absolute text-white bg-gradient-to-r from-black'>
        ...
        <div className='gap-4 flex'>
            ...
            rounded-md gap-2 '> <FaPlay/>Play</button>
            <button className='py-2 px-8 flex items-center justify-center gap-2 bg-gray-500/45 hover:bg-gray-500/65 text-white cursor-pointer font-helonik 
